...
export default function ContactDeveloper() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg mt-20">
      ...
      <div className='w-full px-2 rounded-lg bg-gradient-to-r from-blue-200 to-yellow-300 hover:text-xl '>
        <h2 className="text-2xl font-bold text-gray-800 mb-6 mx-48">Contact Developer</h2>
      </div>
